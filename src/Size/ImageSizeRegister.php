...
namespace Dbout\WpImage\Size;

use Dbout\WpImage\WpImageException;

/**
 * Class ImageSizeRegister
 * @package Dbout\WpImage\Size
 *
...
class ImageSizeRegister
{
    ...
    protected function throwExist(string $name): bool
    {
        if(key_exists($name, $this->sizes)) {
            throw new WpImageException(sprintf('Image format %s already exists', $name));
        }
